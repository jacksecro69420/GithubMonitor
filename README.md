...
- Open the downloaded `.dmg` or installer file. This will show a new window with the app’s icon.
- Drag the GithubMonitor icon to your Applications folder.
...
GithubMonitor only accesses your GitHub data to show notifications and status. It does not store your login details locally in plain text. The app uses GitHub’s secure OAuth system for authentication.

You can revoke the app’s access to your GitHub account at any time through GitHub’s settings.

---

## ⚡ Updating GithubMonitor
